...
<head>
    ...
    <title>Chỉnh Sửa Sản Phẩm Mới</title>
    <!-- Tailwind CSS -->
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="name" id="name" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="${product.name}">
                    ...
                    <div>
                        ...
                        <input type="number" name="price" id="price" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="${product.price}">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="size" id="size" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white px-3 py-2" >
                            <c:choose >
                                <c:when test="${product.size == 'S'}">
                                    <option value="S" selected>S</option>
                                    <option value="M">M</option>
                                    <option value="L">L</option>
                                    <option value="XL">XL</option>
                                </c:when>
                                <c:when test="${product.size == 'M'}">
                                    <option value="S">S</option>
                                    <option value="M" selected>M</option>
                                    <option value="L">L</option>
                                    <option value="XL">XL</option>
                                </c:when>
                                <c:when test="${product.size == 'L'}">
                                    <option value="S">S</option>
                                    <option value="M">M</option>
                                    <option value="L" selected>L</option>
                                    <option value="XL">XL</option>
                                </c:when>
                                <c:when test="${product.size == 'XL'}">
                                    <option value="S">S</option>
                                    <option value="M">M</option>
                                    <option value="L">L</option>
                    ...
                    <div class="flex items-center pt-6">
                        <input id="best_seller" name="best_seller" type="checkbox" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" value="true" <c:if test="${product.best_seller}">checked</c:if>>
                    ...
                    hover:file:bg-blue-100">
                        ...
                        <input type="hidden"  value="${product.image_url}" name="image_url_old" hidden>
                        <img src="${product.image_url}" alt="${product.name}" class="w-32 h-32 object-cover mt-2 rounded-lg">
